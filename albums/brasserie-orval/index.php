  ...
  <section class="py-2 text-center container">
    ...
    <div class="row py-2 py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light mb-5">Brasserie d'Orval</h1>
        <p class="lead text-muted">En 1931, l'installation d'une brasserie au sein même de l'abbaye fut décidée afin d'aider financièrement à la construction du nouveau monastère. Actuellement et dans la tradition cistercienne, la communauté monastique consacre principalement à l'aide sociale les revenus liés à la bière vendue sous la marque Orval. </p>
      </div>
    </div>
