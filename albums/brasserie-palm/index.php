...
<head>
    ...
    <title>Le Bock Trotter · La Brasserie Palm</title>
    <meta name="description" content="Le site d'un cervalobélophile. Collection de sous-bocks et d'objets de brasserie dédiés à la Brasserie Palm">
  ...
  <section class="py-2 text-center container">
    ...
    <div class="row py-2 py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light mb-5">Brasserie Palm</h1>
