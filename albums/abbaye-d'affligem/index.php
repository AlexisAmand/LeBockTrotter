...
<head>
    ...
    <title>Le Bock Trotter · La Brasserie d'Affligem</title>
    <meta name="description" content="Le site d'un cervalobélophile. Collection de sous-bocks et d'objets de brasserie dédiés à Collection de sous-bocks et d'objets de brasserie dédiés à l'Abbaye d'Affligem">
  ...
  <section class="py-2 text-center container">
    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Abbaye d'Affligem</h1>
