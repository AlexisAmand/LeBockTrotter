...
<head>
    ...
    <title>Le Bock Trotter · Bars et Restaurants</title>
    <meta name="description" content="Le site d'un cervalobélophile. Collection de sous-bocks et d'objets de brasserie liés aux bars et aux restaurants situés en France">
  ...
  <section class="py-2 text-center container">
    ...
    <div class="row py-2 py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light mb-5">Bars et Restos</h1>
        <p class="lead text-muted">- Établissements situés en France -</p>
      </div>
    </div>
