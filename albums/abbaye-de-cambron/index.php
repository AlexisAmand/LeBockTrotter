...
<head>
    ...
    <title>Le Bock Trotter · Abbaye de Cambron</title>
    <meta name="description" content="Le site d'un cervalobélophile. Collection de sous-bocks et d'objets de brasserie dédiés à l'Abbaye de Cambron">
  ...
  <section class="py-2 text-center container">
    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Abbaye de Cambron</h1>
