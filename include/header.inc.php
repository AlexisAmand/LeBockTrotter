      ...
      <div class="row">
        ...
        <h4 class="text-white">Belgique</h4>
          <ul class="list-unstyled">
            ...
            <li><a href="/albums/brasserie d'achouffe/index.php" class="text-white">Brasserie d'Achouffe</a></li>          
        ...
        <h4 class="text-white">Pays-Bas</h4>
          <ul class="list-unstyled">
            <li><a href="/albums/abbaye-notre-dame-de-koningshoeven/index.php" class="text-white">Abbaye ND de Koningshoeven</a></li>
